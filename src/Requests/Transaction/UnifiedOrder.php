...
namespace LeshuaPay\Requests\Transaction;
...
class UnifiedOrder extends BasePay
{
     ...
     * @return $this
     */
    public function setJspayFlag($flag)
    {
        is_numeric($flag) && $this->params['jspay_flag'] = (int)$flag;
        return $this;
    }

    /**
     * 选填
     * @param int $way 1 微信 2支付宝 3 银联二维码
     * @return $this
     */
    public function setPayWay($way)
    {
        $this->params['pay_way'] = Config::PAY_WAY[(int)$way];
        return $this;
    }
     ...
     * @return $this
     */
    public function setOrderExpiration($second)
    {
        $second && $this->params['order_expiration'] = (int)$second;
        return $this;
    }
    ...
    {
        $subOpenid && $this->params['sub_openid'] = $subOpenid;
        return $this;
    }
    /**
     * 微信openid
